...
#ifndef __MK3CURSOR_TYPE_H__
#define __MK3CURSOR_TYPE_H__
...
typedef struct {
  ...
  // The condition is part of the 'mk3cursor',
  // but the mutex protects a variable so it is part of the 'mk3array'
  pthread_cond_t  cond;
